...
OWNER_ID = int(getenv("OWNER_ID", "7028661864"))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/god_musician")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Goduniverse_offical_1")
